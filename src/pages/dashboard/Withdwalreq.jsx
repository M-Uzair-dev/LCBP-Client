...
const Withdwalreq = ({ show }) => {
  ...
  const load = async () => {
    try {
      ...
      const response = await fetch(
        `https://lcbp-earn-api.vercel.app/api/withdraws/get`,
        {
          method: "GET",
          headers: {
  ...
  const accept = async (id) => {
    try {
      const result = await fetch(
        `https://lcbp-earn-api.vercel.app/api/withdraws/accept`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const reject = async (id) => {
    try {
      const result = await fetch(
        `https://lcbp-earn-api.vercel.app/api/withdraws/reject`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
